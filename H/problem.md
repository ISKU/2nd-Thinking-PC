...
<p>혁진이는 이러한 기능을 갖춘 새로운 자료구조인 예측 큐를 만들려고 한다. 혁진이를 도와 혁진이가 일할 수 있는 시간 동안 몇 개의 일을 처리할 수 있는지 알아보자.</p>
...
<p>다음 <em>M</em>개의 각 줄에는 혁진이가 일할 수 있는 시간 <em>T</em> (1 ≤ <em>T</em> ≤ 2×10<sup>9</sup>)가 주어진다.</p>
